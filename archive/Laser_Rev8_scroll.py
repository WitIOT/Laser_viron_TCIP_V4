...
class App(tk.Tk):
    ...
    def _build_config_tab(self, parent):
        ...
        # ---- Temp & RH Sensor Settings (child of parent, not lf) ----
        sensor_lf = ttk.LabelFrame(parent, text="Temp & RH Sensor Settings")
        sensor_lf.grid(row=2, column=0, sticky="nwe", padx=10, pady=(0, 6))
        ...
        ttk.Label(lf, text="Logs directory").grid(row=5, column=0, sticky="w", padx=6, pady=6)
        ttk.Entry(lf, textvariable=self.log_dir_var, width=70).grid(row=5, column=1, sticky="we", padx=6, pady=6)
        ...
        ttk.Label(lf, text="Warmup lead (min)").grid(row=8, column=0, sticky="w", padx=6, pady=6)
        ttk.Entry(lf, textvariable=self.monday_warmup_lead_min_var, width=12).grid(row=8, column=1, sticky="w", padx=6, pady=6)

        ttk.Label(lf, text="DTEMF ready >= (°C)").grid(row=9, column=0, sticky="w", padx=6, pady=6)
        ttk.Entry(lf, textvariable=self.monday_warmup_threshold_var, width=12).grid(row=9, column=1, sticky="w", padx=6, pady=6)
        ...
        ttk.Button(lf, text="Browse", command=browse_dir).grid(row=5, column=2, padx=6, pady=6)

        roof_lf = ttk.LabelFrame(parent, text="Auto Roof Timing")
        roof_lf.grid(row=3, column=0, sticky="nwe", padx=10, pady=(0, 10))
